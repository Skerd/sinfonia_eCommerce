...
function DeactivateShippingZoneDialog({
    open,
    onClose,
    entity,
    resolveLanguageKey,
...
export default compose(
    withLanguage(
        "src/modules/eCommerce/clients/panel/private/shippingZones/center/dialogs/deactivateShippingZoneDialog.tsx",
    ),
    withAxios<ActionMessage, PostPayload>(
        {url: "/api/eCommerce/shippingZone/deactivate", method: "POST", data: {}},
        true,
    ),
    withDebug(true, true),
