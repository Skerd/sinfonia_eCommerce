...
type DeactivateDiscountProps = WithLanguageType & {
    entity: Pick<Discount, "_id" | "isActive">;
    onAction: (action: string) => void;
};

function DeactivateDiscount({entity, resolveLanguageKey, onAction}: DeactivateDiscountProps) {
    ...
    return (
        <DropdownMenuItem onClick={() => onAction("deactivateDiscount")}>
