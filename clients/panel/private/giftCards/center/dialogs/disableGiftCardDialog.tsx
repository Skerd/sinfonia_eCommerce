...
function DisableGiftCardDialog({
    open,
    onClose,
    entity,
    resolveLanguageKey,
...
export default compose(
    withLanguage(
        "src/modules/eCommerce/clients/panel/private/giftCards/center/dialogs/disableGiftCardDialog.tsx",
    ),
    withAxios<GiftCardEntity, PostPayload>(
        {url: "/api/eCommerce/giftCard/disable", method: "POST", data: {}},
        true,
    ),
    withDebug(true, true),
