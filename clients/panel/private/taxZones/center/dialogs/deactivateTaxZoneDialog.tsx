...
function DeactivateTaxZoneDialog({
    open,
    onClose,
    entity,
    resolveLanguageKey,
...
export default compose(
    withLanguage(
        "src/modules/eCommerce/clients/panel/private/taxZones/center/dialogs/deactivateTaxZoneDialog.tsx",
    ),
    withAxios<ActionMessage, PostPayload>(
        {url: "/api/eCommerce/taxZone/deactivate", method: "POST", data: {}},
        true,
    ),
    withDebug(true, true),
