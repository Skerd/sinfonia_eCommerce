...
type Props = WithLanguageType &
    WithAxiosType<CmsBlock, PostPayload> & {
        open: boolean;
        onClose: () => void;
        entity: CmsBlock;
        onSuccess?: (block: CmsBlock) => void;
    };

function DeactivateCmsBlockDialog({
    open,
    onClose,
    entity,
    resolveLanguageKey,
...
export default compose(
    withLanguage(
        "src/modules/eCommerce/clients/panel/private/cmsBlocks/center/dialogs/deactivateCmsBlockDialog.tsx",
    ),
    withAxios<CmsBlock, PostPayload>(
        {url: "/api/eCommerce/cmsBlock/deactivate", method: "POST", data: {}},
        true,
    ),
    withDebug(true, true),
